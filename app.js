...
async function init() {
  ...
  // I så fall: sett klubb automatisk og gjenopprett økt uten å vise hjemskjermen
  ...
  if (urlKlubbId && urlOktId && KLUBBER[urlKlubbId]) {
    ...
    oppdaterKlubbUI();
    // Oppdater klubb-velgeren på hjemskjermen i bakgrunnen
    const velger = document.getElementById('klubb-velger');
  ...
  // Ingen delt lenke — vis hjemskjerm som vanlig
  naviger('hjem');
  return;
}
