...
function veksleSpiller(id) {
  ...
  const sokVerdi = sok?.value ?? '';
  if (sokVerdi.trim()) {
    // Søk er aktivt — oppdater søkeresultatene i panelet
    visSokIPanel(sokVerdi);
  } else {
    // Ingen søk — oppdater siste deltakere normalt
