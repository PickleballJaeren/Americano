...
function _beregnDrømmemakker(kamper) {
  ...
  for (const k of kamper) {
    const registrerPar = (id1, id2, vant) => {
      ...
      if (!parMap[nøkkel]) parMap[nøkkel] = { id1, id2, navn1: null, navn2: null, seire: 0, kamper: 0 };
      parMap[nøkkel].kamper++;
      if (vant) parMap[nøkkel].seire++;

      // Lagre navn
      if (k.lag1_s1 === id1 || k.lag1_s2 === id1) {
        parMap[nøkkel].navn1 = k.lag1_s1 === id1 ? k.lag1_s1_navn : k.lag1_s2_navn;
        parMap[nøkkel].navn2 = k.lag1_s1 === id2 ? k.lag1_s1_navn : k.lag1_s2_navn;
      } else {
        parMap[nøkkel].navn1 = k.lag2_s1 === id1 ? k.lag2_s1_navn : k.lag2_s2_navn;
        parMap[nøkkel].navn2 = k.lag2_s1 === id2 ? k.lag2_s1_navn : k.lag2_s2_navn;
      }
    };
